        ...
        if (req.user) {
            if (req.user.role == "admin") {
                if (data.oferta === "1") {
                    ...
                    // }
                    console.log(req.files.portada.path.split("\\").pop());
                    data.portada = portada_name;

                    const uploadedImageName = uploadedFile.req.files.portada.name;
                    const uploadedImageSize = uploadedFile.req.files.portada.size;
                    const uploadedImageType = uploadedFile.files.portada.type;
                    ...
                    console.log(req.files.portada.name, 'NOMBRE');
                    console.log(req.files.portada.size, 'SIZE');
                    console.log(req.files.portada.type, 'TYPE');
