...
//                     if (data.fin_oferta < data.createdAt) {
//                         return res.status(400).send({ message: "fin_oferta < createdAt" });
//                     }
//                 } else {
        ...
        if (categoria_arr.length === 0) {
            if (req.user && req.user.role === "admin") {
                ...
                if (data.oferta == 'true') {
                    ...
                    if (typeof data.fin_oferta === 'undefined') {
                        data.fin_oferta = new Date("0001-01-01T00:00:00.000Z");
                    } else {
