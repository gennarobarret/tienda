            ...
            try {
                if (req.files) {
                    ...
                    if (existingCategory && existingCategory.portada) {
                        ...
                        fs.unlinkSync(`uploads/categoria/${existingCategory.portada}`);
                    }
                    ...
                    if (!reg) {
                        // If the update failed, revert the file update
                        if (shouldUpdateFile) {
                            fs.unlinkSync(`uploads/categoria/${portada_name}`);
                        }
                    ...
                    // ... (existing code for updating without file)
                }
            } catch (error) {
