...
// AGREGAR IMAGEN GALERIAS PRODUCTO
...
// ELIMINAR IMAGEN GALERIAS PRODUCTO
...
//   let reviews = await Review.find({ producto: id })
//     .populate("cliente")
//     .sort({ createdAt: -1 });
