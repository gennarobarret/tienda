...
import { FormControl, NG_VALIDATORS, AbstractControl, Validator, ValidationErrors, ValidatorFn } from '@angular/forms';
...
@Directive({
  ...
  providers: [{
    ...
    useExisting: SvgValidationDirectiveDirective,
    multi: true,
  }],
})

export class SvgValidationDirectiveDirective implements Validator {
