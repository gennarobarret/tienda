...
export class OfertaService {
  ...
  registro_oferta_admin(data: any, file: any, token: any): Observable<any> {
    ...
    fd.append('nombre', data.nombre_oferta);
    fd.append('descuento', data.descuento_oferta);
    fd.append('descripcion', data.descripcion_oferta);
    fd.append('inicio_oferta', data.inicio_oferta);
    fd.append('fin_oferta', data.fin_oferta);
    fd.append('portada', file);
    fd.append('estado', data.estado_oferta);
