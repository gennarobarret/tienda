...
export class CreateSubcategoriaComponent implements OnInit {
  ...
  initializeForm(): void {
    ...
    //   response => {
    //     this.ofertas_subcategoria = response.data;
    //     // console.log(this.oferta);
    //     this.ofertas_subcategoria.forEach(element => {
    ...
    //   response => {
    //     this.categorias_subcategoria = response.data;
  ...
  onCategoriaSeleccionada(event: Event): void {
    ...
    // console.log(`ID de la oferta seleccionada: ${idOfertaSeleccionado}`);
    // Establecer el valor en el formulario
    this.subcategoriaForm.patchValue({ categoria_subcategoria: idOfertaSeleccionado });
  }
  ...
  resetForm(): void {
    // Reset the entire form group
    this.subcategoriaForm.reset({
      nombre_subcategoria: '',
      categoria_subcategoria: '',
      estado_subcategoria: true,
      ofertas_subcategoria: [] // Reset 'ofertas_categoria' to an empty array
    });
  }
