...
export class EditSubcategoriaComponent {
  ...
  constructor(
    ...
    this.updateForm = this.fb.group({
      ...
      estado_subcategoria: [false],
      ofertas_subcategoria: this.fb.control({ value: '', disabled: false }),
      createdAt: [''],
      updatedAt: [''],
    });
            ...
            this._subcategoriaService.obtener_subcategoria_admin(this.id, this.token).subscribe(
              (response: any) => {
                ...
                if (response.data === undefined) {
                  ...
                  // console.log(estado_subcategoria);
  ...
  get icono_subcategoria() {
    return this.updateForm.get("icono_subcategoria")!;
  }

  get estado_subcategoria() {
    return this.updateForm.get("estado_subcategoria")!;
  }
  get oferta_subcategoria() {
    return this.updateForm.get("ofertas_subcategoria")!;
  }
