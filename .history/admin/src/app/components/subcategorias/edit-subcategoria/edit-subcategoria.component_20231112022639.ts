      ...
      (ofertasResponse: any) => {
        ...
        this._categoriaService.listar_categorias_admin(this.filtro, this.token).subscribe(
          (categoriasResponse: any) => {
            ...
            // Set the initial value for the category selection dropdown
            const selectedCategoryId = /* Logic to get the selected category ID */;
            const selectedCategory = this.categorias.find(categoria => categoria._id === selectedCategoryId);
              ...
              (subcategoriasResponse: any) => {
                ...
                if (subcategoriasResponse.data === undefined) {
                  ...
                  this.updateForm.patchValue({
                    ...
                    categoria_subcategoria: this.categorias.find(categoria => categoria._id === categoria_subcategoria), estado_subcategoria: estado_subcategoria,
