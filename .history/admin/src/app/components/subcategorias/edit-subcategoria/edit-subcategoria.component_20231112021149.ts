              ...
              (subcategoriasResponse: any) => {
                ...
                if (subcategoriasResponse.data === undefined) {
                  ...
                  this.updateForm.patchValue({
                    ...
                    categoria_subcategoria: categoria_subcategoria._id,
                  ...
                  console.info('categoria_subcategoria:', formValue.categoria_subcategoria);
                  console.info('estado_subcategoria:', formValue.estado_subcategoria);
                  console.info('createdAt:', formValue.createdAt);
                  console.info('updatedAt:', formValue.updatedAt);
                }
              },
              (error) => {
                console.log(error);
