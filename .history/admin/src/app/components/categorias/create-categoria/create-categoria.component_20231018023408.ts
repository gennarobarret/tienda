...
export class CreateCategoriaComponent implements OnInit {
    ...
    public registro(): void {
        ...
        const ofertasIdsString = formValue.ofertas_categoria; // La cadena con IDs de ofertas
        const ofertasIdsArray = ofertasIdsString.split(',').map((id: string) => ({ _id: id }));
        formValue.ofertas_categoria = ofertasIdsArray;
