...
export class CreateCategoriaComponent implements OnInit {
    ...
    updatedAppliedIds: any[] = [];
    updatedAvailableIds: any[] = [];
    ...
    moveSelectedOffers(action: 'toApplied' | 'toAvailable'): void {
        ...
        if (action === 'toApplied') {
            ...
            this.updatedAppliedIds = this.ofertasDisponibles;
            ...
            this.updatedAvailableIds = this.ofertasAplicadas;
            console.log(this.updatedAvailableIds);

        }

        // Update the form controls with the new values
        this.categoriaForm.patchValue({
            ofertasDisponibles: this.updatedAppliedIds,
            ofertasAplicadas: this.updatedAvailableIds
        });
