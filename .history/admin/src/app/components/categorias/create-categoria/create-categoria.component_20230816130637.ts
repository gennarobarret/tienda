      ...
      if (this.file === undefined && this.categoria.oferta === '1') {
        ...
        this._categoriaService.registro_categoria_admin(this.categoria, this.file, this.token).subscribe(
          (response) => {
            ...
            //   if (this.file) {
            //     // Upload the file here using the same service method
            //     const fileData = {
            //       titulo: this.categoria.titulo,
            //       icono: this.categoria.icono,
            //       estado: this.categoria.estado,
            //       oferta: this.categoria.oferta,
            //       portada: this.file,
            //       descuento_oferta: this.categoria.descuento_oferta,
            //       fin_oferta: this.categoria.fin_oferta
            //     };
            //     console.log(fileData); this._categoriaService.registro_categoria_admin(fileData, null, this.token).subscribe(
            //       (uploadResponse) => {
