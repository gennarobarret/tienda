...
export class CreateCategoriaComponent implements OnInit {
    ...
    public registro(): void {
        ...
        const selectedOfferIds: string[] = formValue.ofertas_categoria.split(','); // Divide la cadena en un array de IDs
        console.log(selectedOfferIds); // Aquí tendrás un array de IDs de ofertas
