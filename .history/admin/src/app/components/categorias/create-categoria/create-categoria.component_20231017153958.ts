...
export class CreateCategoriaComponent implements OnInit {
    ...
    exchangeOffers(action: 'toApplied' | 'toAvailable'): void {
        ...
        if (action === 'toApplied') {
            ...
            console.log('this.ofertasAplicadas ', this.ofertasAplicadas);
            this.ofertasDisponibles = this.ofertasDisponibles.filter((offer) => !selectedOfferAvailableIds.includes(offer._id));
            console.log('this.ofertasDisponibles', this.ofertasDisponibles);
