...
export class CreateCategoriaComponent {
  ...
  resetForm() {
    ...
    // Clear the file input element using template reference
    if (this.fileInput) {
      this.fileInput.nativeElement.value = null;
    }

    // Update the label text back to "Seleccionar imagen" using the property
  ...
  //     this.labelSelectImagen = this.fileInput.nativeElement.files[0].name;
  //   } else {
  //     this.labelSelectImagen = 'Seleccionar imagen';
  //   }
  // }
