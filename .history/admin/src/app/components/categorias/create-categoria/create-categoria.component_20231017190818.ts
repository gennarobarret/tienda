...
export class CreateCategoriaComponent implements OnInit {
    ...
    updateFormArray(controlName: string, event: any) {
        // Obtiene el valor actual del control desde el formulario
        const formArray = this.categoriaForm.get(controlName) as FormArray;
        // Limpia el control (elimina todos los elementos seleccionados)
        formArray.clear();
        // Obtiene las opciones seleccionadas del evento
        const selectedOptions = event.target.selectedOptions;
        // Agrega los elementos seleccionados al control del formulario
