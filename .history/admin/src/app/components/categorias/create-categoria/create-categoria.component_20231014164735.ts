...
export class CreateCategoriaComponent implements OnInit {
    ...
    moveSelectedOffers(action: 'toApplied' | 'toAvailable'): void {
        const selectedOfferIds = this.categoriaForm.get('ofertasDisponibles')!.value;
        ...
        if (action === 'toApplied') {
            ...
            console.log(this.ofertasDisponibles);
            this.ofertasAplicadas = this.ofertasAplicadas.concat(this.ofertasDisponibles.filter((offer) => selectedOfferIds.includes(offer._id)));
            ...
            this.ofertasDisponibles = this.ofertasDisponibles.concat(this.ofertasAplicadas.filter((offer) => selectedOfferIds.includes(offer._id)));
        }
