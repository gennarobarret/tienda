...
export class CreateCategoriaComponent implements OnInit {
    ...
    moveSelectedOffers(action: 'toApplied' | 'toAvailable'): void {
        ...
        this.categoriaForm.patchValue({
            ofertasDisponibles: selectedOfferAvailableIds,
            ofertasAplicadas: selectedOfferApplyIds,
        });
    ...
    public registro(): void {
        ...
        // // Update the 'ofertasDisponibles' and 'ofertasAplicadas' arrays based on the selected options
        // this.ofertasDisponibles = this.categoriaForm.get('ofertasDisponibles')!.value;
        // this.ofertasAplicadas = this.categoriaForm.get('ofertasAplicadas')!.value;
