...
export class CreateCategoriaComponent implements OnInit {
    ...
    public registro(): void {
        ...
        // Extract _id from each selected offer and convert them to mongoose.Types.ObjectId
        const selectedOfferIds = formValue.ofertas_categoria.map((offerId: string) => new mongoose.Types.ObjectId(offerId));
