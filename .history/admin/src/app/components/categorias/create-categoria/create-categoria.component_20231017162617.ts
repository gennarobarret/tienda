...
export class CreateCategoriaComponent implements OnInit {
    ...
    moveSelectedOffers(action: 'toApplied' | 'toAvailable'): void {
        ...
        const previouslySelectedAvailableIds = selectedOfferAvailableIds.filter((id: any) => this.ofertasDisponibles.some((offer) => offer._id === id));
        const previouslySelectedApplyIds = selectedOfferApplyIds.filter((id: any) => this.ofertasAplicadas.some((offer) => offer._id === id));
