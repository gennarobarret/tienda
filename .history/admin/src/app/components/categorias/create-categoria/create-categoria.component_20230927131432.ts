...
export class CreateCategoriaComponent implements OnInit {
    ...
    public registro(): void {
        ...
        // Verificar si los controles existen antes de habilitarlos/deshabilitarlos
        if (ofertaControl && descuentoOfertaControl && fechaOfertaControl && portadaControl) {
            const formValue = this.categoriaForm.value;

            // Habilitar los campos temporalmente
            descuentoOfertaControl.enable();
            fechaOfertaControl.enable();
            portadaControl.enable();
            ...
            descuentoOfertaControl.disable();
            fechaOfertaControl.disable();
            portadaControl.disable();
