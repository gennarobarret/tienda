...
export class CreateCategoriaComponent implements OnInit {
    ...
    ofertasDisponiblesSeleccionadas: any[] = [];
    ofertasAplicadasSeleccionadas: any[] = [];
    ...
    moveSelectedOffers(action: 'toApplied' | 'toAvailable'): void {
        ...
        if (action === 'toApplied') {
            ...
            // Actualiza la propiedad adicional con las ofertas seleccionadas
            this.ofertasDisponiblesSeleccionadas = selectedOfferAvailableIds;
            this.ofertasAplicadasSeleccionadas = this.ofertasAplicadasSeleccionadas.concat(selectedOfferAvailableIds);
        } else if (action === 'toAvailable') {
            // Mueve las ofertas seleccionadas de ofertasAplicadas de regreso a ofertasDisponibles
            ...
            // Actualiza la propiedad adicional con las ofertas seleccionadas
            this.ofertasDisponiblesSeleccionadas = this.ofertasDisponiblesSeleccionadas.concat(selectedOfferApplyIds);
            this.ofertasAplicadasSeleccionadas = selectedOfferApplyIds;
        }
    }
