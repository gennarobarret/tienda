...
export class CreateCategoriaComponent implements OnInit {
    ...
    initializeForm(): void {
        ...
        this._categoriaService.listar_categorias_admin(this.filtro, this.token).subscribe(
            response => {
                this.ofertasAplicadas = response.data;
                console.log('ofertasAplicadas', this.ofertasAplicadas);
                this.ofertasAplicadas.forEach(oferta => {
                    console.log('Ofertas de la categoría:', oferta.nombre_categoria);
                    if (Array.isArray(oferta.ofertas_categoria)) {
                        oferta.ofertas_categoria.forEach((ofertaCategoria: any) => {
                            console.log('ID de oferta:', ofertaCategoria._id);
                        });
                    }
                });
