...
export class CreateCategoriaComponent implements OnInit {
    ...
    exchangeOffers() {
        const temp = this.categoriaForm.get('ofertasDisponibles')?.value || [];
        console.log(temp);
        this.categoriaForm.get('ofertasDisponibles')?.setValue(this.categoriaForm.get('ofertasAplicadas')?.value || []);
        this.categoriaForm.get('ofertasAplicadas')?.setValue(temp);
    }
