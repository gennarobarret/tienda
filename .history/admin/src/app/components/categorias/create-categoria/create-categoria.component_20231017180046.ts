...
export class CreateCategoriaComponent implements OnInit {
    ...
    moveSelectedOffers(action: 'toApplied' | 'toAvailable'): void {
        ...
        // Now, update the form controls with the updated values
        this.categoriaForm.get('ofertasDisponibles')!.setValue(this.ofertasDisponibles.map(offer => offer._id));
        this.categoriaForm.get('ofertasAplicadas')!.setValue(this.ofertasAplicadas.map(offer => offer._id));
    }
