...
export class CreateCategoriaComponent implements OnInit {
    ...
    offer: any; // Declare the offer property
    ...
    setSelectedOfferAndApplyOffer(offer: any) {
        this.selectedOffer = offer;
        this.applyOffer(this.selectedOffer);
    }

    setSelectedOfferAndRemoveOffer(offer: any) {
        this.selectedOffer = offer;
    ...
    applyOffer(offer: any) {
        if (offer && offer._id) {
            // Move the selected offer to applied offers
