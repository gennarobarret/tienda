...
export class CreateCategoriaComponent implements OnInit {
        ...
        if (ofertaControl && descuentoOfertaControl && fechaOfertaControl && portadaControl) {
            ofertaControl.valueChanges.subscribe((ofertaValue) => {
                if (ofertaValue === false) {
                    // Deshabilitar los controles sin emitir eventos de cambio
    ...
    public registro(): void {
        ...
        // Habilitar los campos temporalmente
        this.categoriaForm.get('descuento_oferta').enable();
        this.categoriaForm.get('fin_oferta').enable();
        this.categoriaForm.get('portada').enable();

        // Envía el formulario, por ejemplo, usando una función o servicio para hacer una solicitud HTTP

        // Después de enviar el formulario, puedes deshabilitar los campos nuevamente
        this.categoriaForm.get('descuento_oferta').disable();
        this.categoriaForm.get('fin_oferta').disable();
        this.categoriaForm.get('portada').disable();
