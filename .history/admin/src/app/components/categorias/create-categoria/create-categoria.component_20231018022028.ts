...
export class CreateCategoriaComponent implements OnInit {
    ...
    public registro(): void {
        ...
        const cadenaDeObjetos = formValue.ofertas_categoria.map((offer: any) => ({ _id: offer._id }));
        // formValue.ofertas_categoria = selectedOfferIds.split(',');
        // Convierte la cadena JSON en un array de objetos
        // Convierte la cadena JSON en un array de objetos
        const objetos: Offer[] = JSON.parse(cadenaDeObjetos);

        // Utiliza el método map para extraer los valores de _id y crear un nuevo array
        const selectedOfferIds = objetos.map(objeto => objeto._id);
