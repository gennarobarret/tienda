...
export class CreateCategoriaComponent implements OnInit {
    ...
    agregarOfertaAplicada(): void {
        if (this.ofertas_disponibles) {
            ...
            const ofertas_disponibles = this.ofertas_categoria.find(offer => offer.id === this.ofertas_disponibles);
            if (ofertas_disponibles) {
                // Remove the selected offer from the list of available offers
                this.ofertas_categoria = this.ofertas_categoria.filter(offer => offer.id !== ofertas_disponibles.id);
                // Add the selected offer to the list of "Ofertas Aplicadas"
                this.ofertas_aplicadas.push(ofertas_disponibles);
