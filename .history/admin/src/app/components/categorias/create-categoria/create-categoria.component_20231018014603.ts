...
export class CreateCategoriaComponent implements OnInit {
    ...
    public registro(): void {
        ...
        // Extract _id from each selected offer and store them in an array of objects
        // const selectedOfferIds = formValue.ofertas_categoria.map((offer: any) => ({ _id: offer._id }));

        // Set the modified "ofertas_categoria" field in the form value
        formValue.ofertas_categoria = "6527f008bda2a89543209293", "6527f036bda2a89543209298";

        console.log(formValue);
        // // Convert formValue to a JSON string
        // const dataToSend = JSON.stringify(formValue);
