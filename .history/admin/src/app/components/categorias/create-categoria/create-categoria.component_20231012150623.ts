...
export class CreateCategoriaComponent implements OnInit {
    ...
    agregarOfertaAplicada(): void {
        ...
        for (const ofertaId of ofertasSeleccionadas) {
            const oferta = this.ofertas_disponibles.find(o => o.id === ofertaId);
            if (oferta) {
                this.ofertas_aplicadas.push(oferta);
                this.ofertas_disponibles = this.ofertas_disponibles.filter(o => o.id !== ofertaId);
            }
        }
    ...
    quitarOfertaAplicada(): void {
        ...
        // Mueve las ofertas seleccionadas de aplicadas a disponibles
        for (const ofertaId of ofertasSeleccionadas) {
            const oferta = this.ofertas_aplicadas.find(o => o.id === ofertaId);
            if (oferta) {
                this.ofertasDisponibles.push(oferta);
                this.ofertas_aplicadas = this.ofertas_aplicadas.filter(o => o.id !== ofertaId);
            }
        }
