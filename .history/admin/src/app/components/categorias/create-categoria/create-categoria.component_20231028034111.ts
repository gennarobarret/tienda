...
export class CreateCategoriaComponent implements OnInit {
    ...
    resetForm(): void {
        ...
        if (!ofertasControl) {
            // If 'ofertas_categoria' control doesn't exist, create it
            this.categoriaForm.addControl('ofertas_categoria', this.fb.control([]));
        } else {
            // If the control exists, reset its value by assigning an empty array
            ofertasControl.setValue([]);
        }
    }
