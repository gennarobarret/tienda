...
export class CreateCategoriaComponent implements OnInit {
    ...
    private ofertasAplicadasSubscription: Subscription;
    private ofertasDisponiblesSubscription: Subscription;
    ...
    initializeForm(): void {
        ...
        //     ofertasAplicadasControl.setValue(this.ofertasAplicadas.map(offer => offer._id));
        // }

        // const ofertasDisponiblesControl = this.categoriaForm.get('ofertasDisponibles');
        // if (ofertasDisponiblesControl) {
        //     ofertasDisponiblesControl.setValue(this.ofertasDisponibles.map(offer => offer._id));
        // }
    ...
    subscribeToFormChanges(): void {
        ...
        // Subscribe to changes in ofertasAplicadas and ofertasDisponibles
        this.ofertasAplicadasSubscription = this._ofertaService.getOfertasAplicadasObservable().subscribe(
            (ofertasAplicadas: any[]) => {
        ...
        this.ofertasDisponiblesSubscription = this._ofertaService.getOfertasDisponiblesObservable().subscribe(
            (ofertasDisponibles: any[]) => {
    ...
    moveSelectedOffers(action: 'toApplied' | 'toAvailable'): void {
        ...
        const updatedAppliedIds = this.categoriaForm.get('ofertasAplicadas')!.value;
        const updatedAvailableIds = this.categoriaForm.get('ofertasDisponibles')!.value;
