...
export class CreateCategoriaComponent implements OnInit {
    ...
    public registro(): void {
        ...
        const OfferIds: string[] = formValue.ofertas_categoria.split(','); // Divide la cadena en un array de IDs
        console.log(OfferIds); // Aquí tendrás un array de IDs de ofertas
