...
export class CreateCategoriaComponent implements OnInit {
    ...
    moveSelectedOffers(action: 'toApplied' | 'toAvailable'): void {
        const previouslySelectedAvailableIds = this.categoriaForm.get('ofertasDisponibles')!.value;
        const previouslySelectedApplyIds = this.categoriaForm.get('ofertasAplicadas')!.value;
        ...
        // Restaurar los valores previamente seleccionados
