...
export class CreateCategoriaComponent implements OnInit {
    ...
    public registro(): void {
        ...
        // Check that selectedOffers is correctly populated
        console.log(this.selectedOffers);

        // Map _id values from selectedOffers and store them in ofertas_categoria
        this.ofertas_categoria = this.selectedOffers.map(offer => offer._id);

        console.log(this.ofertas_categoria); // Check that ofertas_categoria is correctly populated
