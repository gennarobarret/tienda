...
export class EditCategoriaComponent {
  ...
  toggleDropdownState(): void {
    const estadoFormControl = this.updateForm.get('estado_categoria');

    // Check the value of estado_categoria control and disable the dropdown accordingly
    if (estadoFormControl?.value) {
