...
export class EditCategoriaComponent {
  ...
  subscribeToFormChanges(): void {
    ...
    const estadoCategoriaControl = this.updateForm.get('estado_categoria');
    const ofertasCategoriaControl = this.updateForm.get('ofertas_categoria');

    if (estadoCategoriaControl && ofertasCategoriaControl) {
      estadoCategoriaControl.valueChanges.subscribe((estadoValue) => {
        if (estadoValue) {
