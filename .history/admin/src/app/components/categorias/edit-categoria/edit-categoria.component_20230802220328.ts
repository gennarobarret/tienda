...
export class EditCategoriaComponent {
  ...
  ofertaInactive() {
    ...
    console.log('isOfertaInactive:', this.isOfertaInactive);
  ...
  actualizar() {
    ...
    if (this.updateForm.valid && this.categoria.descuento_oferta !== '0' || this.categoria.portada !== "undefined") {
      console.log(this.showNotificationError, 'actualiza sin errores');
      console.log("mostrar error", this.showNotificationError2);
      // this.showFileErrorMessage('No hay una imagen para enviar');
      // return;
