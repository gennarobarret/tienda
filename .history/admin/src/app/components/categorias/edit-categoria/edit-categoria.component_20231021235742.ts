    ...
    this._categoriaService.obtener_categoria_admin(this.id, this.token).subscribe(
      (response: any) => {
        ...
        if (response.data === undefined) {
          ...
          // Store ofertasAplicadas in a separate array
          this.ofertasAplicadas = response.data.ofertas_categoria;

          // Combine ofertasAplicadas and ofertasDisponibles
          ...
          this.updateForm.patchValue({
            ...
            ofertas_categoria: this.ofertasAplicadas, // Initialize with ofertasAplicadas selected
            createdAt: createdAt,
            updatedAt: updatedAt,
          });
        }
