...
export class EditCategoriaComponent {
  ...
  constructor(
    ...
    this.updateForm = this.fb.group({
      ...
      ofertas_categoria: [{ value: '', disabled: true }],
      createdAt: [''],
      updatedAt: [''],
    });
    this.updateForm.get('ofertas_categoria')!.disable()
  ...
  get ofertas_categoria() {
    return this.updateForm.get("oferta_categoria")!;
  }


  switchByControl() {
    if (this.disable) {
      this.updateForm.get("oferta_categoria")?.disable();
    } else {
      this.updateForm.get("oferta_categoria")?.enable();
    }
  }

  switch4() {
    this.disable = !this.disable;
    this.switchByControl();
