...
export class EditCategoriaComponent {
  ...
  ofertaInactive() {
    const isOfferInactive = this.categoria.oferta == 0 || this.categoria.oferta === '';

    if (isOfferInactive) {
      this.categoria.descuento_oferta === '0' ? this.showErrorZero = false : null;
      this.categoria.descuento_oferta === '' ? (this.categoria.descuento_oferta = 0, this.categoria.fin_oferta = '0000-00-00') : null;
      this.categoria.portada === 'undefined' || this.categoria.portada === undefined ? this.showErrorEmply = false : null;
    } else {
      this.categoria.portada === 'undefined' || this.categoria.portada === undefined ? this.showErrorEmply = true : null;
      this.categoria.descuento_oferta === 0 ? (this.categoria.descuento_oferta = '', this.categoria.fin_oferta = '') : null;
    }
  }
  ...
  resetForm() {
    ...
    this.categoria = { estado: '', oferta: '', updatedAt: this.categoria.updatedAt, createdAt: this.categoria.createdAt, descuento_oferta: '' };
