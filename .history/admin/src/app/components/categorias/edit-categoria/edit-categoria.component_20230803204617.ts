...
export class EditCategoriaComponent {
  ...
  ofertaInactive() {
    ...
    if (this.categoria.descuento_oferta === 0) {
      if (this.isOfertaInactive) {
        ...
        this.showNotificationError2 = false;
  ...
  fileChangeEvent(event: any): void {
    ...
    // Hide the error when isOfertaInactive is true (field is not required)
    this.showNotificationError2 = !this.isOfertaInactive && this.categoria.portada === 'undefined';
  }
