...
export class EditCategoriaComponent {
  ...
  dropdownSettings = {
    ...
    noDataLabel: 'Sin ofertas disponibles',
  };
    ...
    this._categoriaService.obtener_categoria_admin(this.id, this.token).subscribe(
      response => {
        ...
        if (response.data === undefined) {
          ...
          const { nombre_categoria, icono_categoria, estado_categoria, oferta, descuento_oferta, fin_oferta, portada, createdAt, updatedAt } = response.data;
