...
export class EditCategoriaComponent {
  ...
  ofertaInactive() {
    ...
    console.log('inactivo', this.categoria.descuento_oferta === 0);
    if (this.isOfertaInactive) {
      this.categoria.descuento_oferta = 0;
      this.categoria.fin_oferta = '';
      this.showNotificationError = false;
    } else {
      console.log('activo', this.categoria.descuento_oferta === 0);
  ...
  actualizar() {
    ...
    if (this.updateForm.valid && this.categoria.descuento_oferta !== '0') {
      ...
      console.log(this.showNotificationError, 'no muestra error');
      // const data: any = {};
      // if (this.file) {
