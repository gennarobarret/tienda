...
export class EditCategoriaComponent {
  ...
  public ofertaValue: string | undefined = ''; // New property to store oferta dropdown value
  ...
  disableOfertaFields() {
    ...
    this.ofertaValue = this.categoria.oferta; // Store the value of the oferta dropdown
  }
