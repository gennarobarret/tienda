...
export class EditCategoriaComponent {
  ...
  selectedFile: any | ArrayBuffer = 'assets/img/default.jpg';
  url = GLOBAL.url;
  // imgSelected: any | ArrayBuffer = 'assets/img/default.jpg';
    ...
    this._categoriaService.obtener_categoria_admin(this.id, this.token).subscribe(
      response => {
        ...
        if (response.data === undefined) {
          ...
          this.selectedFile = this.url + 'obtener_portada_categoria/' + portada;
