...
export class EditCategoriaComponent implements OnInit {
        ...
        this._adminService.obtener_categoria_admin(this.id, this.token).subscribe(
          response => {
            if (response.data == undefined) {
              ...
              // this.listar_etiquetas_categoria();
  ...
  // listar_etiquetas_categoria() {
  //   this.load_etiquetas = true;
  //   this._adminService.listar_categorias_categoria_admin(this.id, this.token).subscribe(
  //     response => {
  ...
  //   this.load_etiquetas = true;
  //   this._adminService.eliminar_etiqueta_categoria_admin(id,this.token).subscribe(
  //     response=>{
  //       this.listar_etiquetas_categoria();
  //       this.load_etiquetas = false;
  //     }
  ...
  //   }
  //   this.load_etiquetas = true;
  //   this._adminService.agregar_etiqueta_categoria_admin(data,this.token).subscribe(
  //     response=>{
  //       this.listar_etiquetas_categoria();
  //       this.load_etiquetas = false;
  //     }
  ...
  actualizar(actualizarForm: any) {
    if (actualizarForm.valid) {
      ...
      this._adminService.actualizar_categoria_admin(data, this.id, this.token).subscribe(
        response => {
          iziToast.show({
            title: 'SUCCESS',
            titleColor: '#1DC74C',
