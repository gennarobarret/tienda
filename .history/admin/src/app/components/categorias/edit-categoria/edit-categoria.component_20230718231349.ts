...
export class EditCategoriaComponent {
  ...
  disableInputs() {
    // Assuming you have access to the input fields using ViewChild or ElementRef.
    // For demonstration purposes, let's assume they are Angular Template Reference Variables.
    this.descuentoInput.disabled = true;
    this.finOfertaInput.disabled = true;
    this.portadaInput.disabled = true;
  }
