...
export class EditCategoriaComponent {
  ...
  public config_global: any = {}; public load_data = false;
  ...
  //   // Add the following lines to set the readonly property for "Fecha Fin Oferta"
  //   this.updateForm.form.get('fin_oferta')?.enable({ onlySelf: true });
  //   this.updateForm.form.get('fin_oferta')?.readonly = true;
  // }
  ...
  isFechaFinOfertaReadonly(): boolean {
  ...
  //     this.updateForm.form.get('fin_oferta')?.enable({ onlySelf: true });
  //     this.updateForm.form.get('fin_oferta')?.setValue('0000-00-00', { onlySelf: true });
  //     this.updateForm.form.get('fin_oferta')?.readonly = true;
  //   } else {
  //     this.updateForm.form.get('fin_oferta')?.readonly = false;
  //   }
  // }
