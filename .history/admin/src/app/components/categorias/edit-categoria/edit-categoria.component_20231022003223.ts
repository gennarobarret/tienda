...
export class EditCategoriaComponent implements OnInit {
  ...
  initializeForm() {
    ...
    this.ofertaService.listar_ofertas_admin(this.id).subscribe((ofertasResponse: any) => {
      this.ofertasDisponibles = ofertasResponse.data;
      this.categoriaService.obtener_categoria_admin(this.id).subscribe((categoriaResponse: any) => {
  ...
  actualizar() {
    ...
    this.categoriaService.actualizar_categoria_admin(data, this.id).subscribe(
      response => {
