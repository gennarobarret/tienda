...
export class IndexCategoriaComponent implements OnInit {
  ...
  constructor(
    ...
    private sanitizer: DomSanitizer, private modalService: NgbModalprivate modalService: NgbModalprivate modalService: NgbModal
  ...
  abrirModal() {
    ...
    modalRef.componentInstance.imagen = this.url + 'obtener_portada_categoria/' + this.item.portada;
  }
