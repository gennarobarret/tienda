...
export class CreateOfertaComponent implements OnInit {
  ...
  initializeForm(): void {
    this.ofertaForm = this.fb.group({
      nombre: [{ value: null, disabled: true }, [Validators.required, Validators.minLength(1), Validators.maxLength(25), Validators.pattern("^[a-zA-Z0-9\\sñÑ]+$")]],
      descripcion: [{ value: null, disabled: true }, [Validators.required, Validators.minLength(1), Validators.maxLength(250), Validators.pattern("^[a-zA-Z0-9\\sñÑ]+$")]],
      descuento_oferta: [{ value: null, disabled: true }, [Validators.required, this.validateDiscountRange.bind(this)]],
      inicio_oferta: [{ value: '', disabled: true }, [Validators.required, this.validateStartOfertDate.bind(this)]],
      fin_oferta: [{ value: '', disabled: true }, [Validators.required, this.validateEndOfertDate.bind(this)]],
  ...
  private validateStartOfertDate(control: FormControl): { [key: string]: any } | null {

    const inicioOfertaStr: string = inicioOfertaControl.value;
    ...
    if (isNaN(inicioOfertaDate.getTime())) {
  ...
  private validateEndOfertDate(control: FormControl): { [key: string]: any } | null {
    ...
    // if (isNaN(finOfertaDate.getTime())) {
    //   this.showErrorMessage('Una de las fechas introducidas no es válida.');
    //   return { 'invalidDate': true };
    // }
