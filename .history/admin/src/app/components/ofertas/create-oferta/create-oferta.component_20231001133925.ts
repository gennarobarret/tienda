...
export class CreateOfertaComponent implements OnInit {
  ...
  initializeForm(): void {
    this.ofertaForm = this.fb.group({
      ...
      portada_oferta: [{ value: null, disabled: true }, [Validators.required]],
  ...
  subscribeToFormChanges(): void {
    ...
    const Inicio_ofertaOfertaControl = this.ofertaForm.get('inicio_oferta');
    ...
    if (estado_ofertaControl && nombre_ofertaOfertaControl && descuentoOfertaControl && descripcion_ofertaControl && Inicio_ofertaOfertaControl && fin_ofertaOfertaControl && portada_ofertaControl) {
      estado_ofertaControl.valueChanges.subscribe((estado_ofertaValue) => {
        if (estado_ofertaValue === false) {
          this.imageUrl = 'assets/img/default.jpg';
          this.selectedFile = null;
          [nombre_ofertaOfertaControl, descripcion_ofertaControl, descuentoOfertaControl, Inicio_ofertaOfertaControl, fin_ofertaOfertaControl, portada_ofertaControl].forEach(control => {
