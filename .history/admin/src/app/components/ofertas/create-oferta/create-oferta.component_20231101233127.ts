...
export class CreateOfertaComponent implements OnInit {
  ...
  initializeForm(): void {
    this.ofertaForm = this.fb.group({
      ...
      nivel_oferta: [{ value: true, disabled: true }, [Validators.required]],
    });
  }
  ...
  subscribeToFormChanges(): void {
    ...
    if (estado_ofertaControl && nombre_ofertaOfertaControl && descuento_ofertaControl && descripcion_ofertaControl && inicio_ofertaControl && fin_ofertaOfertaControl && portada_ofertaControl && nivel_ofertaControl) {
