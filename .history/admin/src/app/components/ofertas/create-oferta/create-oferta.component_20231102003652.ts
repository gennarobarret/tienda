...
export class CreateOfertaComponent implements OnInit {
  ...
  niveles: any[] = [
    {
      "_id": "1",
      "nombre_oferta": "Categorias",
    },
    {
      "_id": "2",
      "nombre_oferta": "Subcategorias",
    },
    {
      "_id": "3",
      "nombre_oferta": "Productos",
    },
  ];
  ...
  initializeForm(): void {
    ...
    this.ofertaForm = this.fb.group({
      ...
      nivel_oferta: ['Select Nivel Oferta', [Validators.required]],
    });
    // Setting the initial value for 'nivel_oferta' to 'null' after the form is initialized
    this.nivel_oferta.setValue(null);
  }
