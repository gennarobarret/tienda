...
export class CreateOfertaComponent implements OnInit {
  ...
  public registro(): void {
    ...
    const inicio_oferta = new Date(); // Replace this with your actual date value
    const fin_oferta = new Date();   // Replace this with your actual date value
    const inicio_ofertaUTC = inicio_oferta.toISOString();
    const fin_ofertaUTC = fin_oferta.toISOString();
    // console.log('inicio_oferta UTC:', inicio_ofertaUTC);
    // console.log('fin_oferta UTC:', fin_ofertaUTC);

    this.ofertaForm.patchValue({
      inicio_oferta: inicio_ofertaUTC,
      fin_oferta: fin_ofertaUTC,
    });
