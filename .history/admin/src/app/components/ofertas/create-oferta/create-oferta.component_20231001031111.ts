...
export class CreateOfertaComponent implements OnInit {
  ...
  initializeForm(): void {
    this.ofertaForm = this.fb.group({
      ...
      inicio_oferta: [{ value: '', disabled: true }, [Validators.required, this.validateOfertDate.bind(this.inicio_oferta)]],
      fin_oferta: [{ value: '', disabled: true }, [Validators.required]],
  ...
  private validateOfertDate(inicioOfertaControl: FormControl, finOfertaControl: FormControl): { [key: string]: any } | null {
