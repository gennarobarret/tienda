...
export class CreateOfertaComponent implements OnInit {
  ...
  initializeForm(): void {
    this.ofertaForm = this.fb.group({
      ...
      descripcion_oferta: [{ value: null, disabled: true }, [Validators.required, Validators.minLength(1), Validators.maxLength(250), Validators.pattern("^[a-zA-Z0-9\\sñÑ]+$")]],
  ...
  subscribeToFormChanges(): void {
    ...
    const descripcion_ofertaOfertaControl = this.ofertaForm.get('descripcion_oferta');
    ...
    if (estado_ofertaControl && nombre_ofertaOfertaControl && descuentoOfertaControl && descripcion_ofertaOfertaControl && fechaInicioOfertaControl && fechaFinalOfertaControl && portadaControl) {
      estado_ofertaControl.valueChanges.subscribe((estado_ofertaValue) => {
        if (estado_ofertaValue === false) {
          this.imageUrl = 'assets/img/default.jpg';
          this.selectedFile = null;
          [nombre_ofertaOfertaControl, descripcion_ofertaOfertaControl, descuentoOfertaControl, fechaInicioOfertaControl, fechaFinalOfertaControl, portadaControl].forEach(control => {
