...
export class CreateOfertaComponent implements OnInit {
  ...
  private validateOfertDate(control: FormControl): { [key: string]: any } | null {
    ...
    if (startDateControl && startDateControl.value) {
      ...
      //   return { 'invalidStartDateTime': true };
      // }
      ...
      if (endDateControl && endDateControl.value) {
        ...
        // if (startDate > endDate) {
        //   this.showErrorMessage('Debes corregir la fecha de inicio de la oferta, la fecha de inicio de la oferta debe ser anterior a la fecha final.');
        //   return { 'invalidEndDateTime': true };
        // }
    ...
    if (endDateControl && endDateControl.value) {
      // Error si la fecha y hora de finalización es menor que la actual
      if (endDate < currentDate) {
      ...
      // Error si la fecha y hora de finalización es menor que la inicial
      // if (startDate > endDate) {
      //   this.showErrorMessage('Debes corregir la fecha de inicio de la oferta, la fecha de inicio de la oferta debe ser anterior a la fecha final.');
      //   return { 'invalidEndDateTime': true };
      // }
      ...
      if (startDateControl && startDateControl.value) {
        if (endDate < startDate) {
          // Error si la fecha y hora de finalización de la oferta es mayor que la inicial
          this.showErrorMessage('La fecha y hora de finalización de la oferta no puede ser anterior a la fecha de inicio.');
          return { 'invalidEndDate': true };
        } else {
          // Si la fecha y hora de finalización de la oferta es mayor que la inicial, elimina los errores en inicio_oferta
