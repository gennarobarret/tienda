...
export class CreateOfertaComponent implements OnInit {
  ...
  subscribeToFormChanges(): void {
    ...
    if (estadoControl && nombreOfertaControl && descuentoOfertaControl && descripcionOfertaControl && fechaOfertaControl && portadaControl) {
      estadoControl.valueChanges.subscribe((estadoValue) => {
        if (estadoValue === false) {
          this.imageUrl = 'assets/img/default.jpg';
          this.selectedFile = null;
          [nombreOfertaControl, descripcionOfertaControl, descuentoOfertaControl, fechaOfertaControl, portadaControl].forEach(control => {
