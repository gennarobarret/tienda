...
export class CreateOfertaComponent implements OnInit {
  ...
  subscribeToFormChanges(): void {
    ...
    if (estado_ofertaControl && nombreOfertaControl && descuentoOfertaControl && descripcionOfertaControl && fechaInicioOfertaControl && fechaFinalOfertaControl && portadaControl) {
      estado_ofertaControl.valueChanges.subscribe((estado_ofertaValue) => {
        if (estado_ofertaValue === false) {
          this.imageUrl = 'assets/img/default.jpg';
          this.selectedFile = null;
          [nombreOfertaControl, descripcionOfertaControl, descuentoOfertaControl, fechaInicioOfertaControl, fechaFinalOfertaControl, portadaControl].forEach(control => {
  ...
  public registro(): void {
    ...
    this._ofertaService.listar_ofertas_admin(filtro, this.token).subscribe(
      ...
      (error) => {
        this.showErrorMessage('Ocurrió un error en al buscar nombre en base de datos');
        this.load_btn = false;
      }
    );
  }
