    ...
    this._ofertaService.obtener_oferta_admin(this.id, this.token).subscribe(
      ofertasResponse => {
        ...
        if (ofertasResponse.data === undefined) {
          ...
          const { nombre_oferta, estado_oferta, descripcion_oferta, descuento_oferta, inicio_oferta, fin_oferta, portada_oferta, nivel_oferta, createdAt, updatedAt } = ofertasResponse.data;
