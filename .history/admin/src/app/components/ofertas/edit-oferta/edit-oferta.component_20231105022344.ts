...
export class EditOfertaComponent {
  ...
  subscribeToFormChanges(): void {
    ...
    const c = this.updateForm.get('fin_oferta');
    const portada_ofertaControl = this.updateForm.get('portada_oferta');
    const nivel_ofertaControl = this.updateForm.get('nivel_oferta');



    if (nivel_ofertaControl && estado_ofertaControl && nombre_ofertaOfertaControl && descuento_ofertaControl && descripcion_ofertaControl && inicio_ofertaControl && fin_ofertaOfertaControl && portada_ofertaControl) {
      estado_ofertaControl.valueChanges.subscribe((ofertaValue) => {
        if (ofertaValue === false) {
          // this.imageUrl = 'assets/img/default.jpg';
          // this.selectedFile = null;
          [nivel_ofertaControl, nombre_ofertaOfertaControl, descripcion_ofertaControl, descuento_ofertaControl, inicio_ofertaControl, fin_ofertaOfertaControl, portada_ofertaControl].forEach(control => {
