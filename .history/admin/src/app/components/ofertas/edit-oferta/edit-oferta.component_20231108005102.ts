...
export class EditOfertaComponent {
  ...
  initializeForm() {
    ...
    this._subcategoriaService.listar_subcategorias_admin(this.filtro, this.token).subscribe(
      subcategoriasResponse => {
        ...
        console.log(this.ofertaEncontradaSubcat);
  ...
  // Función para manejar el valor actualizado de ofertaEncontradaSubcat
  doSomethingWithSubcatValue(value: boolean) {
    console.log(value);
    // Realizar operaciones con el valor actualizado de this.ofertaEncontradaSubcat
    // Por ejemplo:
    if (value) {
      // Hacer algo si ofertaEncontradaSubcat es true
    } else {
      // Hacer algo si ofertaEncontradaSubcat es false
    }
  }

  // Función para manejar el valor actualizado de ofertaEncontradaCat
  doSomethingWithCatValue(value: boolean) {
    console.log(value);
    // Realizar operaciones con el valor actualizado de this.ofertaEncontradaCat
    // Por ejemplo:
    if (value) {

      // Hacer algo si ofertaEncontradaCat es true
    } else {
      // Hacer algo si ofertaEncontradaCat es false
    }
  }
