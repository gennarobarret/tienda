...
export class EditOfertaComponent {
  ...
  ofertasAplicadasCategorias: any[] = [];
  ofertasAplicadasSubcategorias: any[] = [];
  filtro = '';
  ...
  initializeForm() {
    ...
    this._subcategoriaService.listar_subcategorias_admin(this.filtro, this.token).subscribe(
      subcategoriasResponse => {
        this.ofertasAplicadasSubcategorias = subcategoriasResponse.data;
        console.log(this.ofertasAplicadasSubcategorias);
      },
      error => {
        console.log(error);
        this._router.navigate(['/panel/ofertas']);
    ...
    this._categoriaService.listar_categorias_admin(this.filtro, this.token).subscribe(
      (categoriasResponse: any) => {
        this.ofertasAplicadasCategorias = categoriasResponse.data;
        console.log(this.ofertasAplicadasCategorias);
        this.ofertasAplicadasCategorias.forEach(ofertas => {
          const idOferta = ofertas._id;
          console.log("ID de oferta:", idOferta);
        });
        // console.log(this.ofertasAplicadasCategorias);
      },
      error => {
    ...
    if (nivel_ofertaControl) {
      nivel_ofertaControl.disable(); // This line disables the nivel_oferta control
    }
  }
