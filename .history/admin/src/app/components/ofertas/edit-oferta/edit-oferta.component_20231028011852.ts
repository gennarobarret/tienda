...
export class EditOfertaComponent {
  ...
  subscribeToFormChanges(): void {
    ...
    if (estado_ofertaControl && descuento_ofertaControl && descripcion_ofertaControl && inicio_ofertaControl && fin_ofertaOfertaControl && portada_ofertaControl) {
      estado_ofertaControl.valueChanges.subscribe((ofertaValue) => {
        if (ofertaValue === false) {
          // this.imageUrl = 'assets/img/default.jpg';
          // this.selectedFile = null;
          [descripcion_ofertaControl, descuento_ofertaControl, inicio_ofertaControl, fin_ofertaOfertaControl, portada_ofertaControl].forEach(control => {
