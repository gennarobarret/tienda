...
function validateFILE(fileContent: File, allowedTypes: string[], maxSize: number): boolean {
  if (!fileContent) {
...
export class FileValidatorDirective implements Validator {
  ...
  public validate(control: AbstractControl): ValidationErrors | null {
    ...
    const isValid = validateFILE(fileContent, this.allowedTypes, this.maxSize);
