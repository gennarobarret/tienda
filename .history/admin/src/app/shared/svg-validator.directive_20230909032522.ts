...
const validAttributes: { [key: string]: RegExp } = {
  ...
  d: /^"([MmLlHhVvCcSsQqTtAaZz]|-?\d+(\.\d+)?(?:[eE][+-]?\d+)?(?:\s*,\s*|\s+))-?\d+(\.\d+)?(?:[eE][+-]?\d+)?(?:\s*,\s*|\s+)(-?\d+(\.\d+)?(?:[eE][+-]?\d+)?(?:\s*,\s*|\s+)?-?\d+(\.\d+)?(?:[eE][+-]?\d+)?(?:\s*,\s*|\s+)?)((?:-?\d+(\.\d+)?(?:[eE][+-]?\d+)?(?:\s*,\s*|\s+)?-?\d+(\.\d+)?(?:[eE][+-]?\d+)?(?:\s*,\s*|\s+)?)*)(\s*(?:[CcSsQqTtAaZz]|-?\d+(\.\d+)?(?:[eE][+-]?\d+)?(?:\s*,\s*|\s+))?-?\d+(\.\d+)?(?:[eE][+-]?\d+)?(?:\s*,\s*|\s+)?-?\d+(\.\d+)?(?:[eE][+-]?\d+)?(?:\s*,\s*|\s+)?-?\d+(\.\d+)?(?:[eE][+-]?\d+)?(?:\s*,\s*|\s+)?-?\d+(\.\d+)?(?:[eE][+-]?\d+)?(?:\s*,\s*|\s+)?-?\d+(\.\d+)?(?:[eE][+-]?\d+)?(?:\s*,\s*|\s+)?-?\d+(\.\d+)?(?:[eE][+-]?\d+)?(?:\s*,\s*|\s+)?)?"$/,
...
function validateSVG(
  ...
  if (svgContent) {
    ...
    if (match) {
      ...
      if (!validAttributes['d'].test(dAttribute)) {
